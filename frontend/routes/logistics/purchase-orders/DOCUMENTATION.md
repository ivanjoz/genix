...
visibility: tenant
description_en: >-
  Purchase orders. Orders view: create a new purchase order by selecting supplier, destination
  warehouse, and products with quantities and prices; manage each order's status. Report view:
  query and filter existing purchase orders.
description_es: >-
  Órdenes de compra. Vista Órdenes: crear una nueva orden de compra seleccionando proveedor,
  almacén destino y productos con cantidades y precios; gestionar el estado de cada orden. Vista
  Reporte: consultar y filtrar órdenes de compra existentes.
---
...
files:
  ...
  - path: backend/logistics/purchase_order.go
    ...
    hash: sha256:a4fd6b0a3e66673b7772f64a2d67f7a8f999d76e10fd23f3095c561c506a7da7
