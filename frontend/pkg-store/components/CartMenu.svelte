...
{#snippet cartContent(isMobileVersion: boolean)}
  <div class="p-12 flex flex-col h-[calc(100vh-120px)]">
    <ArrowSteps selected={Ecommerce.cartOption}
      columnsTemplate={!isMobileVersion && Core.deviceType === 3 ? "1fr 1fr 1fr 0.7fr" : ""}
      onSelect={e => {
      ...
      {/if}
        ...
        <div class="mt-12 text-center">
          ...
          <p class="text-gray-600 mb-8">
            Tu pedido ha sido procesado exitosamente. Recibirás un correo de confirmación a la brevedad.
          </p>
          <button
...
{#if !isMobile}
  <div class={css}>
    <ButtonLayer bind:isOpen={isOpen}
      ...
      edgeMargin={32}
      layerClass="w-768! max-w-[82vw]! rounded-[11px]!" useBig>
      {#snippet button(open)}
...
{:else if layerOpenedState.id === id}
  <div class={css}>
    <img class={"absolute h-20 _1 right-17"} alt=""
