...
func PostPerfiles(req *core.HandlerArgs) core.HandlerResponse {
	...
	perfilesToSave := []seguridadTypes.Perfil{body}
	...
	body.PrepareCloudSync()
	if err = cloud.Insert([]seguridadTypes.Perfil{body}); err != nil {
