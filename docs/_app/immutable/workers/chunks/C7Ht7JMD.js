var avif_enc_mt_default = (() => {
	...
	return (function(moduleArg = {}) {
		...
		var ENVIRONMENT_IS_PTHREAD = Module$1["ENVIRONMENT_IS_PTHREAD"] || false;
		var scriptDirectory = "";
		...
		if (ENVIRONMENT_IS_PTHREAD) wasmMemory = Module$1["wasmMemory"];
		else if (Module$1["wasmMemory"]) wasmMemory = Module$1["wasmMemory"];
		else {
		...
		} else wasmBinaryFile = new URL("" + new URL("../assets/avif_enc_mt-DFoVXd45.wasm", import.meta.url).href, "" + import.meta.url).href;
		...
		var PThread = {
			...
			loadWasmModuleToWorker: (worker) => new Promise((onFinishedLoading) => {
				...
				for (var handler of [
					...
					"print",
					"printErr"
				]) if (Module$1.hasOwnProperty(handler)) handlers.push(handler);
				worker.postMessage({
					"cmd": "load",
					"handlers": handlers,
					"urlOrBlob": Module$1["mainScriptUrlOrBlob"],
			...
			allocateUnusedWorker() {
				var worker;
				if (!Module$1["locateFile"]) worker = new Worker(new URL(
					/* @vite-ignore */
					"" + new URL("../avif_enc_mt.worker-DCmtvBVy.js", import.meta.url).href,
					"" + import.meta.url
				), { type: "module" });
				else {
		...
		var establishStackSpace = () => {
			...
			var stackLow = stackHigh - GROWABLE_HEAP_U32()[pthread_ptr + 56 >> 2];
		...
		var invokeEntryPoint = (ptr, arg) => {
			...
			function finish(result$1) {
				if (keepRuntimeAlive()) PThread.setExitStatus(result$1);
		...
		var integerReadValueFromPointer = (name, width, signed) => {
			switch (width) {
				case 1: return signed ? (pointer) => GROWABLE_HEAP_I8()[pointer] : (pointer) => GROWABLE_HEAP_U8()[pointer];
				case 2: return signed ? (pointer) => GROWABLE_HEAP_I16()[pointer >> 1] : (pointer) => GROWABLE_HEAP_U16()[pointer >> 1];
				case 4: return signed ? (pointer) => GROWABLE_HEAP_I32()[pointer >> 2] : (pointer) => GROWABLE_HEAP_U32()[pointer >> 2];
		...
		var __emscripten_thread_mailbox_await = (pthread_ptr) => {
			if (typeof Atomics.waitAsync === "function") {
				Atomics.waitAsync(GROWABLE_HEAP_I32(), pthread_ptr >> 2, pthread_ptr).value.then(checkMailbox);
		...
		var __emscripten_receive_on_main_thread_js = (funcIndex, emAsmAddr, callingThread, numCallArgs, args) => {
			...
			var b = args >> 3;
			for (var i = 0; i < numCallArgs; i++) proxiedJSCallArgs[i] = GROWABLE_HEAP_F64()[b + i];
		...
		var emval_get_global = () => {
			...
			function testGlobal(obj) {
				...
				if (!success) delete obj["$$$embind_global$$$"];
				return success;
			}
			if (typeof $$$embind_global$$$ == "object") return $$$embind_global$$$;
			if (typeof global == "object" && testGlobal(global)) $$$embind_global$$$ = global;
			else if (typeof self == "object" && testGlobal(self)) $$$embind_global$$$ = self;
			if (typeof $$$embind_global$$$ == "object") return $$$embind_global$$$;
		...
		var emval_returnValue = (returnType, destructorsRef, handle) => {
			...
			if (destructors.length) GROWABLE_HEAP_U32()[destructorsRef >> 2] = Emval.toHandle(destructors);
			return result;
		};
		...
		function _fd_write(fd, iov, iovcnt, pnum) {
			...
			for (var i = 0; i < iovcnt; i++) {
				...
				iov += 8;
				for (var j = 0; j < len; j++) printChar(fd, GROWABLE_HEAP_U8()[ptr + j]);
				num += len;
			}
		...
		var wasmImports = {
			...
			o: invoke_viiiii,
			p: invoke_viiiiii,
			a: wasmMemory || Module$1["wasmMemory"]
		};
		var wasmExports = createWasm();
		var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["ca"])();
		var ___getTypeName = (a0) => (___getTypeName = wasmExports["da"])(a0);
		var __embind_initialize_bindings = Module$1["__embind_initialize_bindings"] = () => (__embind_initialize_bindings = Module$1["__embind_initialize_bindings"] = wasmExports["ea"])();
		var _pthread_self = Module$1["_pthread_self"] = () => (_pthread_self = Module$1["_pthread_self"] = wasmExports["fa"])();
		var _malloc = (a0) => (_malloc = wasmExports["ga"])(a0);
		var _free = (a0) => (_free = wasmExports["ha"])(a0);
		var __emscripten_tls_init = Module$1["__emscripten_tls_init"] = () => (__emscripten_tls_init = Module$1["__emscripten_tls_init"] = wasmExports["ia"])();
		var __emscripten_thread_init = Module$1["__emscripten_thread_init"] = (a0, a1, a2, a3, a4, a5) => (__emscripten_thread_init = Module$1["__emscripten_thread_init"] = wasmExports["ja"])(a0, a1, a2, a3, a4, a5);
		var __emscripten_thread_crashed = Module$1["__emscripten_thread_crashed"] = () => (__emscripten_thread_crashed = Module$1["__emscripten_thread_crashed"] = wasmExports["la"])();
		...
		var __emscripten_thread_exit = Module$1["__emscripten_thread_exit"] = (a0) => (__emscripten_thread_exit = Module$1["__emscripten_thread_exit"] = wasmExports["oa"])(a0);
		...
		var dynCall_jiiiiiiiii = Module$1["dynCall_jiiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => (dynCall_jiiiiiiiii = Module$1["dynCall_jiiiiiiiii"] = wasmExports["va"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
		var dynCall_jiji = Module$1["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module$1["dynCall_jiji"] = wasmExports["wa"])(a0, a1, a2, a3, a4);
		var dynCall_iiijii = Module$1["dynCall_iiijii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiijii = Module$1["dynCall_iiijii"] = wasmExports["xa"])(a0, a1, a2, a3, a4, a5, a6);
		var dynCall_jiiiiiiii = Module$1["dynCall_jiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (dynCall_jiiiiiiii = Module$1["dynCall_jiiiiiiii"] = wasmExports["ya"])(a0, a1, a2, a3, a4, a5, a6, a7, a8);
		var dynCall_jiiiiii = Module$1["dynCall_jiiiiii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_jiiiiii = Module$1["dynCall_jiiiiii"] = wasmExports["za"])(a0, a1, a2, a3, a4, a5, a6);
		var dynCall_jiiiii = Module$1["dynCall_jiiiii"] = (a0, a1, a2, a3, a4, a5) => (dynCall_jiiiii = Module$1["dynCall_jiiiii"] = wasmExports["Aa"])(a0, a1, a2, a3, a4, a5);
		...
		Module$1["wasmMemory"] = wasmMemory;
...
export { avif_enc_mt_default as default };
