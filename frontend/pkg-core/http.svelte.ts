...
import type { CacheMode, serviceHttpProps } from '$core/workers/service-worker';
import { accessHelper, getToken } from '$core/lib/security';
import { fetchCache, fetchCacheParsed, sendServiceMessage } from '$core/lib/sw-cache';
