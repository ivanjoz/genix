...
// DAY_ZONE_OFFSET_SECONDS in fareward/src/limiter/time_frame.rs, which is the writer: the two
...
// (fareward/src/limiter/credits_blob.rs). It is deliberately strict about the three rules that
