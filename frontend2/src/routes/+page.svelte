	...
	<div class="max-w-2xl mx-auto p-8">
		...
		<div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8">
			<p class="text-gray-700 dark:text-gray-300 leading-relaxed">
				...
				El menú lateral ha sido migrado desde Solid.js con un diseño moderno y responsive.
			</p>
		</div>
		...
		<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
			...
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
				<div class="text-3xl mb-3">📱</div>
				<h3 class="font-semibold text-gray-900 dark:text-white mb-2">Responsive</h3>
				<p class="text-sm text-gray-600 dark:text-gray-400">
			...
			<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
				<div class="text-3xl mb-3">🎨</div>
				<h3 class="font-semibold text-gray-900 dark:text-white mb-2">Moderno</h3>
				<p class="text-sm text-gray-600 dark:text-gray-400">
